...
public class Sign_in {
    ...
    void loginac(ActionEvent event) throws IOException {
        ...
        loginData.getlogininfo(email);
        String ACnum=loginData.getACNo();
        if(email.equals("") || pass.equals("")){
            infolab.setText("Enter Email and Password");
        }else if(email.equalsIgnoreCase(loginData.getEmail()) && pass.equals(loginData.getPassword())){
            ...
            stage.setTitle(AccountData.getTitle());
